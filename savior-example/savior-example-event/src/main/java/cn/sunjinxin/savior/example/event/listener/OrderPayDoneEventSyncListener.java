...
import cn.sunjinxin.savior.event.listener.sub.SyncListener;
 ...
 */
@Slf4j
public class OrderPayDoneEventSyncListener implements SyncListener<String, OrderPayDoneRequest> {
